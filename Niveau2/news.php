    ...
    <div id="wrapper">
        ...
        <main>
            ...
            while ($post = $lesInformations->fetch_assoc()) {
                $post_id = $post['post_id']; // Utilisez post_id pour l'ID du post
                ...
                <article>
                    ...
                    <address><a target="_blank" href="wall.php?user_id=<?php echo intval($post_id) ?>"><?php echo $post['author_name'] ?></a></address>
                    <div>
                    ...
                    <footer>
                        ...
                        <form method="POST" action="">
                            ...
                            <input type="submit" name="like" value="J'incrémente !">
                        </form>
